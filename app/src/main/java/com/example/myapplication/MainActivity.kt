...
fun MyApp() {
    ...
    NavHost(navController = navController, startDestination = "login") {
        composable("login") {
            MainActivity().ScreenLogin(navController) //Экран регистрации/входа
        }
        composable("main") {
            MainActivity().ScreenMain(navController) //Главный экран
        }
        composable("newparty") {
            MainActivity().NewPartyScreen(navController) //Экран создания вечеринки
        }
        composable("place") {
            MainActivity().MainPLACEScreen(navController) //Экран выбора места
        }
        composable("friends") {
            MainActivity().FriendsListScreen(navController) //Экран создания списка друзей
        }
        composable("dishes") {
            MainActivity().DishListScreen(navController) //Экран выбора блюд
        }
        composable("endfriends") {
            MainActivity().EndPartyScreen(navController) //Экран отправки приглашений
        }
        composable("oldfriends") {
            MainActivity().OldPartyListScreen(navController) //Экран старой вечеринки
        }
        composable("currentparty") {
            MainActivity().PartyCurrentScreen(navController) //Экран текущ вечеринки
        }
        composable("settings") {
            MainActivity().SettingsScreen(navController) //Экран настроек
        }
        composable("data") {
            MainActivity().CalendarScreen(navController) //Экран настроек
        }
    }
}
...
//        Loading()
    ...
    fun PlaceListScreen(
        ...
        val selectedPlaceIndex =
            remember { mutableStateOf<Int?>(null) } // для хранения индекса выбранного элемента
            ...
            Column(
                ...
                Column(
                    ...
                    places.forEachIndexed { index, place ->
                        val borderColor =
                            if (selectedPlaceIndex.value == index) RedBut else Color.Transparent
    ...
    fun DishListScreen(navController: NavController, modifier: Modifier = Modifier) {
        val dish = listOf(
            Dishes(
                ...
                "Оладушки от бабушки”",
                "490 р.",
                "Оладушки со сгущёнкой и вареньем."
            ),
            Dishes(
                R.drawable.image19,
                "Сэндвич Маца”",
                "890 р.",
                "Чиабатта, вяленые помидоры в масле, моцарелла, горчица, салат."
            ),
            Dishes(
                R.drawable.image18,
                "Бэйгл с икрой",
                "990 р.",
                "Бэйгл, авокадо, варёное яйцо, маринованные огурцы, красная икра."
            ),
                    ...
                    Row(
                        ...
                        Box(
                            modifier = Modifier
                                ...
                                .border(
                                    2.dp,
                                    if (isSelected.value) RedBut else Color.Gray,
    ...
    fun OldPartyListScreen(navController: NavController, modifier: Modifier = Modifier) {
        val parties = listOf(
            Party(
                ...
                "Дата: 14 Мая",
                "Место: Ресторан “Дичь”",
                "Друзья: Влад Тисленко, Сергей Калугин..."
            ),
            Party(
                "День рождения Серёжи",
                "Дата: 23 Сен",
                "Место: Ресторан “Дичь”",
                "Друзья: Влад Тисленко, Артём Смагин..."
            ),
            Party(
                "Веселье",
                "Дата: 20 Июн",
                "Место: Ресторан “Plita”",
                "Друзья: Влад Тисленко, Артём Смагин..."
            ),
            Party(
                "Корпоротив",
            ...
            Column(
                ...
                Box(
                    ...
                    Column(
                        ...
                        Text(
                            text = "Select Date",
                            style = TextStyle(fontSize = 16.sp, fontFamily = shantellSans)
                        )
                        Spacer(modifier = Modifier.height(32.dp))
                        Text(
                            text = "Aug 17, 2025",
                            style = TextStyle(fontSize = 20.sp, fontFamily = shantellSans)
                        )
                    }
    ...
    fun DateBlock(day: Int, currentDate: Int, selectedDate: Int, onClick: () -> Unit) {
        ...
        if (day != 0) {
            Box(
                ...
                Text(
                    text = day.toString(),
                    style = TextStyle(fontSize = 12.sp, fontFamily = shantellSans)
                )
            }
        } else {
